...
public class ReviewFactoryTest {
    ...
    public void testCreateReviewValid() {
        ...
        String fullName = "Olwethu";
        int reviewID = 1;
        int rating = 4;
        String comment = "Great car, smooth ride.";

        Review review = ReviewFactory.createReview(reviewID, fullName, car, rating, comment);

        assertNotNull(review);
        assertEquals(reviewID, review.getReviewID());
        assertEquals(fullName, review.getFullName());
    ...
    public void testCreateReviewInvalid() {
        ...
        Review review = ReviewFactory.createReview(-1, "Awonke", new Car(), 4, "Nice");  // Invalid reviewID
        assertNull(review);
    }
